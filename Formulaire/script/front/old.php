...
<!-- Input MOT -->
          ...
          <div hidden>
            ...
            <input class="_input _input-4" type="url" name="sqlimage0<?php echo $i?>" id="sqlimage0<?php echo $i?>" onkeyup="sqlcropimg(this.value, '0<?php echo $i?>');" value="<?php if (isset($_POST['sqlimage0' . $i])){echo $_POST['sqlimage0' . $i];} else {echo $donnees['image0'];} ?>" spellcheck="true">
            <p class="text text-9"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LE NOM DE L'AUTEUR DE L'IMAGE</strong></font></p>
            <input class="_input _input-5" name="sqlauteur0<?php echo $i?>" id="sqlauteur0<?php echo $i?>" type="text"  value="<?php if (isset($_POST['sqlauteur0' . $i])){echo $_POST['sqlauteur0' . $i];} else {echo $donnees['auteur0'];} ?>" spellcheck="true">
            <p class="text text-10"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LA DATE DE MISE EN LIGNE DE L'IMAGE</strong></font></p>
            <input class="_input _input-5" name="sqldate0<?php echo $i?>" id="sqldate0<?php echo $i?>" type="text"  value="<?php if (isset($_POST['sqldate0' . $i])){echo $_POST['sqldate0' . $i];} else {echo $donnees['date0'];} ?>" spellcheck="true">
            ...
            <input class="_input _input-3" type="text" name="sqlindice1<?php echo $i?>" id="sqlindice1<?php echo $i?>" value="<?php if (isset($_POST['sqlindice1' . $i])){echo $_POST['sqlindice1' . $i];} else {echo $donnees['indice1'];} ?>" spellcheck="true">
            ...
            <div hidden>
              ...
              <p class="text text-7"><strong>2- Je sélectionne une image puis je copie&nbsp;</strong><strong></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;l'URL de l'image (adresse dans le navigateur).&nbsp;</strong></p>
              <p class="text text-8"><strong>3- Je colle lURL dans le champs ci-dessous</strong></p>
              <input class="_input _input-4" type="url" name="sqlimage1<?php echo $i?>" id="sqlimage1<?php echo $i?>" onkeyup="sqlcropimg(this.value, '1<?php echo $i?>');" value="<?php if (isset($_POST['sqlimage1' . $i])){echo $_POST['sqlimage1' . $i];} else {echo $donnees['image1'];} ?>" spellcheck="true">
              <p class="text text-9"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LE NOM DE L'AUTEUR DE L'IMAGE</strong></font></p>
              <input class="_input _input-5" name="sqlauteur1<?php echo $i?>" id="sqlauteur1<?php echo $i?>" type="text"  value="<?php if (isset($_POST['sqlauteur1' . $i])){echo $_POST['sqlauteur1' . $i];} else {echo $donnees['auteur1'];} ?>" spellcheck="true">
              <p class="text text-10"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LA DATE DE MISE EN LIGNE DE L'IMAGE</strong></font></p>
              <input class="_input _input-5" name="sqldate1<?php echo $i?>" id="sqldate1<?php echo $i?>" type="text"  value="<?php if (isset($_POST['sqldate1' . $i])){echo $_POST['sqldate1' . $i];} else {echo $donnees['date1'];} ?>" spellcheck="true">
            ...
            <input class="_input _input-3" type="text" name="sqlindice2<?php echo $i?>" id="sqlindice2<?php echo $i?>" value="<?php if (isset($_POST['sqlindice2' . $i])){echo $_POST['sqlindice2' . $i];} else {echo $donnees['indice2'];} ?>" spellcheck="true">
            ...
            <div hidden>
              ...
              <p class="text text-7"><strong>2- Je sélectionne une image puis je copie&nbsp;</strong><strong></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;l'URL de l'image (adresse dans le navigateur).&nbsp;</strong></p>
              <p class="text text-8"><strong>3- Je colle lURL dans le champs ci-dessous</strong></p>
              <input class="_input _input-4" type="url" name="sqlimage2<?php echo $i?>" id="sqlimage2<?php echo $i?>" onkeyup="sqlcropimg(this.value, '2<?php echo $i?>');" value="<?php if (isset($_POST['sqlimage2' . $i])){echo $_POST['sqlimage2' . $i];} else {echo $donnees['image2'];} ?>" spellcheck="true">
              <p class="text text-9"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LE NOM DE L'AUTEUR DE L'IMAGE</strong></font></p>
              <input class="_input _input-5" name="sqlauteur2<?php echo $i?>" id="sqlauteur2<?php echo $i?>" type="text"  value="<?php if (isset($_POST['sqlauteur2' . $i])){echo $_POST['sqlauteur2' . $i];} else {echo $donnees['auteur2'];} ?>" spellcheck="true">
              <p class="text text-10"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LA DATE DE MISE EN LIGNE DE L'IMAGE</strong></font></p>
              <input class="_input _input-5" name="sqldate2<?php echo $i?>" id="sqldate2<?php echo $i?>" type="text"  value="<?php if (isset($_POST['sqldate2' . $i])){echo $_POST['sqldate2' . $i];} else {echo $donnees['date2'];} ?>" spellcheck="true">
            ...
            <input class="_input _input-3" type="text" name="sqlindice3<?php echo $i?>" id="sqlindice3<?php echo $i?>" value="<?php if (isset($_POST['sqlindice3' . $i])){echo $_POST['sqlindice3' . $i];} else {echo $donnees['indice3'];} ?>" spellcheck="true">
            ...
            <div hidden>
              ...
              <p class="text text-7"><strong>2- Je sélectionne une image puis je copie&nbsp;</strong><strong></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;l'URL de l'image (adresse dans le navigateur).&nbsp;</strong></p>
              <p class="text text-8"><strong>3- Je colle lURL dans le champs ci-dessous</strong></p>
              <input class="_input _input-4" type="url" name="sqlimage3<?php echo $i?>" id="sqlimage3<?php echo $i?>" onkeyup="sqlcropimg(this.value, '3<?php echo $i?>');" value="<?php if (isset($_POST['sqlimage3' . $i])){echo $_POST['sqlimage3' . $i];} else {echo $donnees['image3'];} ?>" spellcheck="true">
              <p class="text text-9"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LE NOM DE L'AUTEUR DE L'IMAGE</strong></font></p>
              <input class="_input _input-5" name="sqlauteur3<?php echo $i?>" id="sqlauteur3<?php echo $i?>" type="text"  value="<?php if (isset($_POST['sqlauteur3' . $i])){echo $_POST['sqlauteur3' . $i];} else {echo $donnees['auteur3'];} ?>" spellcheck="true">
              <p class="text text-10"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LA DATE DE MISE EN LIGNE DE L'IMAGE</strong></font></p>
              <input class="_input _input-5" name="sqldate3<?php echo $i?>" id="sqldate3<?php echo $i?>" type="text"  value="<?php if (isset($_POST['sqldate3' . $i])){echo $_POST['sqldate3' . $i];} else {echo $donnees['date3'];} ?>" spellcheck="true">
            ...
            <input class="_input _input-3" type="text" name="sqlrecompense<?php echo $i?>" id="sqlrecompense<?php echo $i?>" value="<?php if (isset($_POST['sqlrecompense' . $i])){echo $_POST['sqlrecompense' . $i];} else {echo $donnees['recompense'];} ?>" spellcheck="true">
            ...
            <div hidden>
              ...
              <p class="text text-7"><strong>2- Je sélectionne une image puis je copie&nbsp;</strong><strong></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;l'URL de l'image (adresse dans le navigateur).&nbsp;</strong></p>
              <p class="text text-8"><strong>3- Je colle lURL dans le champs ci-dessous</strong></p>
              <input class="_input _input-4"  type="url" name="sqlimage4<?php echo $i?>" id="sqlimage4<?php echo $i?>" onkeyup="sqlcropimg(this.value, '4<?php echo $i?>');" value="<?php if (isset($_POST['sqlimage4' . $i])){echo $_POST['sqlimage4' . $i];} else {echo $donnees['image4'];} ?>" spellcheck="true">
              <p class="text text-9"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LE NOM DE L'AUTEUR DE L'IMAGE</strong></font></p>
              <input class="_input _input-5" name="sqlauteur4<?php echo $i?>" id="sqlauteur4<?php echo $i?>" type="text"  value="<?php if (isset($_POST['sqlauteur4' . $i])){echo $_POST['sqlauteur4' . $i];} else {echo $donnees['auteur4'];} ?>" spellcheck="true">
              <p class="text text-10"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LA DATE DE MISE EN LIGNE DE L'IMAGE</strong></font></p>
              <input class="_input _input-5" name="sqldate4<?php echo $i?>" id="sqldate4<?php echo $i?>" type="text"  value="<?php if (isset($_POST['sqldate4' . $i])){echo $_POST['sqldate4' . $i];} else {echo $donnees['date4'];} ?>" spellcheck="true">
