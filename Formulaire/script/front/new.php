...
<div >
  ...
  <input type="url" name="image0" id="image0" class="_input _input-4" onkeyup="cropimg(this.value, 0);" value="<?php if (isset($_POST['image0'])){echo $_POST['image0'];} ?>" spellcheck="true">
  <p class="text text-9"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LE NOM DE L'AUTEUR DE L'IMAGE</strong></font></p>
  <input class="_input _input-5" name="auteur0" id="auteur0" type="text"  value="<?php if (isset($_POST['auteur0'])){echo $_POST['auteur0'];} ?>" spellcheck="true">
...
<a href='javascript:popupResize("resize.php?src=" + image0.value + "&num=0", 0)'>
  ...
  <input class="_input _input-3" type="text" name="indice1" id="indice1" onkeyup="recupindice1(this.value);" value="<?php if (isset($_POST['indice1'])){echo $_POST['indice1'];} ?>" spellcheck="true">
  <div class="element element-6" id="divindice1"></div>
  <p class="_button _button-4 second-arrow">&nbsp;ÉDITER&nbsp;&nbsp;<i class="fa fa-caret-up fa1" style="color:white"></i></p>
  ...
  <div hidden>
    ...
    <p class="text text-7"><strong>2- Je sélectionne une image puis je copie&nbsp;</strong><strong></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;l'URL de l'image (adresse dans le navigateur).&nbsp;</strong></p>
    <p class="text text-8"><strong>3- Je colle lURL dans le champs ci-dessous</strong></p>
    <input type="url" name="image1" id="image1" class="_input _input-4" onkeyup="cropimg(this.value, 1);" value="<?php if (isset($_POST['image1'])){echo $_POST['image1'];} ?>" spellcheck="true">
    <p class="text text-9"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LE NOM DE L'AUTEUR DE L'IMAGE</strong></font></p>
    <input class="_input _input-5" name="auteur1" id="auteur1" type="text" value="<?php if (isset($_POST['auteur1'])){echo $_POST['auteur1'];} ?>" spellcheck="true">
    <p class="text text-10"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LA DATE DE MISE EN LIGNE DE L'IMAGE</strong></font></p>
  ...
  <input class="_input _input-3" type="text" name="indice2" id="indice2" onkeyup="recupindice2(this.value);" value="<?php if (isset($_POST['indice2'])){echo $_POST['indice2'];} ?>" spellcheck="true">
  <div class="element element-6" id="divindice2"></div>
  <p class="_button _button-4 third-arrow">&nbsp;ÉDITER&nbsp;&nbsp;<i class="fa fa-caret-up fa2" style="color:white"></i></p>
  ...
  <div hidden>
    ...
    <p class="text text-7"><strong>2- Je sélectionne une image puis je copie&nbsp;</strong><strong></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;l'URL de l'image (adresse dans le navigateur).&nbsp;</strong></p>
    <p class="text text-8"><strong>3- Je colle lURL dans le champs ci-dessous</strong></p>
    <input type="url" name="image2" id="image2" class="_input _input-4" onkeyup="cropimg(this.value, 2);" value="<?php if (isset($_POST['image2'])){echo $_POST['image2'];} ?>" spellcheck="true">
    <p class="text text-9"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LE NOM DE L'AUTEUR DE L'IMAGE</strong></font></p>
    <input class="_input _input-5" name="auteur2" id="auteur2" type="text" value="<?php if (isset($_POST['auteur2'])){echo $_POST['auteur2'];} ?>" spellcheck="true">
    <p class="text text-10"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LA DATE DE MISE EN LIGNE DE L'IMAGE</strong></font></p>
  ...
  <input class="_input _input-3" type="text" name="indice3" id="indice3" onkeyup="recupindice3(this.value);" value="<?php if (isset($_POST['indice3'])){echo $_POST['indice3'];} ?>" spellcheck="true">
  <div class="element element-6" id="divindice3"></div>
  <p class="_button _button-4 fourth-arrow">&nbsp;ÉDITER&nbsp;&nbsp;<i class="fa fa-caret-up fa3" style="color:white"></i></p>
  ...
  <div hidden>
    ...
    <p class="text text-7"><strong>2- Je sélectionne une image puis je copie&nbsp;</strong><strong></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;l'URL de l'image (adresse dans le navigateur).&nbsp;</strong></p>
    <p class="text text-8"><strong>3- Je colle lURL dans le champs ci-dessous</strong></p>
    <input type="url" name="image3" id="image3" class="_input _input-4" onkeyup="cropimg(this.value, 3);" value="<?php if (isset($_POST['image3'])){echo $_POST['image3'];} ?>" spellcheck="true">
    <p class="text text-9"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LE NOM DE L'AUTEUR DE L'IMAGE</strong></font></p>
    <input class="_input _input-5" name="auteur3" id="auteur3" type="text" value="<?php if (isset($_POST['auteur3'])){echo $_POST['auteur3'];} ?>" spellcheck="true">
    <p class="text text-10"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LA DATE DE MISE EN LIGNE DE L'IMAGE</strong></font></p>
  ...
  <input class="_input _input-3" name="recompense" id="recompense" onkeyup="recupindice4(this.value);" value="<?php if (isset($_POST['recompense'])){echo $_POST['recompense'];} ?>" spellcheck="true">
  <div class="element element-6" id="divindice4"></div>
  <p class="_button _button-4 fifth-arrow">&nbsp;ÉDITER&nbsp;&nbsp;<i class="fa fa-caret-up fa4" style="color:white"></i></p>
  ...
  <div hidden>
    ...
    <p class="text text-7"><strong>2- Je sélectionne une image puis je copie&nbsp;</strong><strong></br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;l'URL de l'image (adresse dans le navigateur).&nbsp;</strong></p>
    <p class="text text-8"><strong>3- Je colle lURL dans le champs ci-dessous</strong></p>
    <input class="_input _input-4" type="url" name="image4" id="image4" onkeyup="cropimg(this.value, 4);" value="<?php if (isset($_POST['image4'])){echo $_POST['image4'];} ?>" spellcheck="true">
    <p class="text text-9"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LE NOM DE L'AUTEUR DE L'IMAGE</strong></font></p>
    <input class="_input _input-5" name="auteur4" id="auteur4" type="text" value="<?php if (isset($_POST['auteur4'])){echo $_POST['auteur4'];} ?>" spellcheck="true">
    <p class="text text-10"><font color="#b2b2b2" face="Quattrocento Sans"><strong>LA DATE DE MISE EN LIGNE DE L'IMAGE</strong></font></p>
    ...
    <textarea name="legende" id="legende" class="_input _input-7"rows="4" cols="50" spellcheck="true"><?php if (isset($_POST['image4'])){echo $_POST['image4'];}?></textarea>
    <div class="element element-11"></div>
  </div>
  <input class="_button _button-5" type="submit" name="submit" value="Envoyer"/>
</div>
</form>
